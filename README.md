...
* 👤  Julian Carrion Tovar     :octocat: jxliian
* 👤  Miguel Angel Luque Gomez     :octocat: mangel
...
![sitemap](./P2/Entrega/sitemap.jpeg)
...
![Wireframe Home](./P2/Entrega/wireframes/home_grid.png)
...
![Wireframe Agenda](./P2/Entrega/wireframes/agenda_grid.png)
...
![Wireframe Mi Perfil](./P2/Entrega/wireframes/perfil_grid.png)
...
| Tarea (NeoQarmita)             |    % Éxito    |  Tiempo medio  | Clics medios |
| :----------------------------- | :------------: | :------------: | :----------: |
| Localizar la agenda de eventos |     100 %     |      20 s      |      3      |
| Realizar una reserva de mesa   |      80 %      |      45 s      |      6      |
| Consultar el menú y precios   |     100 %     |      15 s      |      2      |
| Acceder al Club Qarmita        |      80 %      |      35 s      |      5      |
| **Media general**        | **90 %** | **29 s** | **4** |
...
- El proceso de elegir salsas lo encontraron un poco confuso, al encontrarse en la ultima opción, lo que provocó abandono parcial en Pilar y Nadia.
